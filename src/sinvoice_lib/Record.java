    ...
    public void start() {
        if (STATE_STOP == mState) {
            ...
            if ( mBufferSize >= minBufferSize ) {
                record = new AudioRecord(MediaRecorder.AudioSource.MIC, mFrequence, mChannelConfig, mAudioEncoding, mBufferSize);
                if (null != record) {
                    try {
                        mState = STATE_START;
                        ...
                        LogHelper.d(TAG, "record release");
