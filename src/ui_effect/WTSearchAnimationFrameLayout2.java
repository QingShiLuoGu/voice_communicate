...
public class WTSearchAnimationFrameLayout2 extends FrameLayout {
	private SoftReference<Bitmap> m_bitmapRipple;//软引用
	private ImageView[] m_imageVRadars;

	public WTSearchAnimationFrameLayout2(Context paramContext) {
		super(paramContext);
		init();
	}
	...
	private void init() {
		...
		LayoutInflater.from(getContext()).inflate(
				R.layout.wt_search_device_anima2, this);
		...
		try {
			m_bitmapRipple = new SoftReference<Bitmap>(
					BitmapFactory.decodeStream(getContext().getResources()
							.openRawResource(R.drawable.wifi_body_ripple2)));
	...
	final class WTSearchAnimationHandler implements Animation.AnimationListener {
		...
		public WTSearchAnimationHandler(
				WTSearchAnimationFrameLayout2 paramImageView, ImageView imageView) {
